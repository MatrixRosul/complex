...
export default async function CatalogPage({
  ...
  return (
    <div className="container-complex flex flex-col gap-5 py-6">
      ...
      {/*
        ⚠️ КАТЕГОРІЯ З ПІДГРУПАМИ — ЦЕ ВІТРИНА РОЗДІЛІВ, А НЕ СПИСОК ТОВАРІВ.
        Раніше під плитками одразу вивалювався весь асортимент розділу з фільтрами:
        «Велика побутова техніка» показувала 5 плиток і тут же 26 товарів упереміш —
        пральні поруч із витяжками. Замовник попросив прибрати цю купу: спершу людина
        обирає підрозділ, і вже там бачить товари з релевантними фільтрами.

        Листова категорія (підгруп немає) працює як раніше — інакше на ній не було б
        нічого взагалі.

        Місце під статті/добірки лишається нижче — коли з'явиться контент.
      */}
