      ...
      >
        <div className="relative flex-1">
          ...
          <input
            ...
            className="h-13 w-full rounded-md border border-input bg-card pl-11 pr-3 text-base text-foreground placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/40 focus-visible:outline-none"
          />
        </div>
