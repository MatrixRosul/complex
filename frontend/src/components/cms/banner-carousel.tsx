 ...
 *
 * ⚠️ Слайд ≠ окремий банер. Для промо-ряду слайд — це ВІКНО з трьох сусідніх банерів,
 * зсунуте на один (див. page.tsx): стрілка міняє не всю трійку, а підсовує наступний.
 */
