...
| БД | PostgreSQL (локально 14, у проді 17) |
...
**PostgreSQL 14 локально, 17 у проді.** Тому нічого з PG15+ використовувати не можна.
...
(ADR-016). CI ганяється на прод-версії і цієї помилки **не спіймає** — спіймає розробник.
