    ...
    fieldsets = (
        ...
        (
            "Медіа",
            {
                ...
                "в меню каталогу (кругла іконка біля назви), «Плитка» — велике фото для "
                "головної сторінки. Обидва необовʼязкові: без емблеми в меню буде типовий "
                "значок, без плитки — типове оформлення. Завантажене видно в колонці "
                "«Емблема» у списку категорій.",
            },
        ),
        (
            "Основне",
