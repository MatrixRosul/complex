...
| Q10 | **Акцентний колір** | ✅ **Закрито 20.07.2026.** Замовниця надіслала логотип — темно-синій вордмарк COMPLEX `#0E3F68`. Акцент = бренд-синій `#15558F`, топбар/лого `#0E3F68`, підкладка `#EAF1F8` (DESIGN_SYSTEM §2). Помаранчевий лишився тільки в маскота-лисички | ✅ Перефарбування виявилось НЕ переверсткою: уся тема жила в токенах `globals.css`, змінились значення, а не розмітка |
...
- [ ] **FE-01 · Дизайн-система в код** ⭐ **передумова ВСЬОГО фронту** — 1 д
      ...
      ✅Q10 закрито 20.07.2026: бренд-синій `#15558F` / `#0E3F68` від логотипу замовниці
